...
export function buildSystemPrompt({ agentSetupBlock, characterCard, compactOpenLoops, context, intelBlock, urgentBlock }) {
  const now = new Date();
...
YOUR ROLE:
- You know everything about them from their profile, GitHub, and LinkedIn below
